            ...
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container-fluid"><a class="navbar-brand" href="#">Rentaly</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        </form><span class="navbar-text"> <a class="login" href="login">Accedi</a></span><a class="btn btn-light action-button" role="button" href="register">Registrati</a></div>
                </div>
            </nav>
            <div class="container hero">
                <div class="row">
                    <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <p>Sei pronto a trovare il tuo nuovo appartamento?</p><button class="btn btn-light btn-lg action-button" type="button">Cerca la tua nuova casa</button></div>
                </div>
            </div>
        </div>
    </div>
