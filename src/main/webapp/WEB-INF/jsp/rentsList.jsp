...
<ul class="list-group">
    <c:if test="${empty rents}">
        <div class="card list-group-item list-group-item-action justify-content-between align-items-center">
            <div class="card-body">
                <div class="row">
                    <h4>Non hai ancora creato un affitto.</h4>
                    <a class="btn btn-primary justify-content-center" id="realties" href="#">Immobili</a>
                </div>
            </div>
        </div>
    </c:if>
        ...
        <div class="card list-group-item list-group-item-action justify-content-between align-items-center">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-danger" id="deleteRent" onclick="setSelected(${r.id});">Elimina affitto</button>
                        <button class="btn btn-success" data-toggle="modal" data-target="#addCheckModal" onclick="setSelected(${r.id});">Crea spesa</button>
                    </div>
                </div>
            </div>
        </div>
