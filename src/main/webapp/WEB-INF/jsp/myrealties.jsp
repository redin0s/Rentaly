...
<html>
	...
	<body>
        ...
        <ul class="nav nav-tabs justify-content-center" id="tabList" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="rents-tab" data-toggle="tab" href="#rents" role="tab" aria-controls="rents" aria-selected="false">Affitti</a>
            </li>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h6 class="text-muted mb-2" id="cost">Data di inizio: ${r.start}</h6>
                                        <h6 class="text-muted mb-2" id="cost">Data di fine: ${r.end}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
